...
use voku\SimplePhpParser\BetterReflectionForOldPhp\SourceLocator\SourceStubber\Exception\CouldNotFindPhpStormStubs;
...
final class PhpStormStubsSourceStubber implements SourceStubber
{
     ...
     *
     * @var array<string, Node\Expr\FuncCall|Node\Stmt\Const_|null>
     */
    ...
    /**
     * @param Node\Expr\FuncCall|Node\Stmt\ClassLike|Node\Stmt\Const_|Node\Stmt\Function_ $node
     */
    ...
    private function createCachingVisitor(): NodeVisitorAbstract
    {
        return new class() extends NodeVisitorAbstract {
            ...
            /**
             * @var array<string, Node\Expr\FuncCall|Node\Stmt\Const_>
             */
            private $constantNodes = [];
            ...
            /**
             * @return array<string, Node\Expr\FuncCall|Node\Stmt\Const_>
             */
