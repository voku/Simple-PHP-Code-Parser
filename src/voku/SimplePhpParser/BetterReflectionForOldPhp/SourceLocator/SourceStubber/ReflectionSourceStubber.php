...
final class ReflectionSourceStubber implements SourceStubber
{
    ...
    /**
     * @param Class_|Function_|Interface_|Method|Property|Trait_                                     $node
     ...
     * @param CoreReflectionFunctionAbstract $functionReflectionAbstract
     *
     * @return mixed|null
     */
    ...
    /**
     * @param CoreReflectionNamedType $type
     *
     * @return FullyQualified|Name|NullableType
     */
