...
namespace voku\SimplePhpParser\BetterReflectionForOldPhp\SourceLocator\Type\Composer\Factory;
...
use voku\SimplePhpParser\BetterReflectionForOldPhp\SourceLocator\Type\Composer\Factory\Exception\FailedToParseJson;
use voku\SimplePhpParser\BetterReflectionForOldPhp\SourceLocator\Type\Composer\Factory\Exception\InvalidProjectDirectory;
use voku\SimplePhpParser\BetterReflectionForOldPhp\SourceLocator\Type\Composer\Factory\Exception\MissingComposerJson;
use voku\SimplePhpParser\BetterReflectionForOldPhp\SourceLocator\Type\Composer\Factory\Exception\MissingInstalledJson;
use voku\SimplePhpParser\BetterReflectionForOldPhp\SourceLocator\Type\Composer\Psr\Psr0Mapping;
use voku\SimplePhpParser\BetterReflectionForOldPhp\SourceLocator\Type\Composer\Psr\Psr4Mapping;
use voku\SimplePhpParser\BetterReflectionForOldPhp\SourceLocator\Type\Composer\PsrAutoloaderLocator;
...
final class MakeLocatorForComposerJsonAndInstalledJson
{
    public function __invoke(string $installationPath, Locator $astLocator): SourceLocator
    {
        ...
        /** @psalm-var list<array{name: string, autoload: array{classmap: array<int, string>, files: array<int, string>, psr-4: array<string, array<int, string>>, psr-0: array<string, array<int, string>>}}>|null $installed*/
