...
use voku\SimplePhpParser\BetterReflectionForOldPhp\TypesFinder\FindReturnType;
...
use voku\SimplePhpParser\BetterReflectionForOldPhp\Util\Visitor\ReturnNodeVisitor;
...
abstract class ReflectionFunctionAbstract
{
    ...
    /**
     * @var Node\Expr\Closure|Node\Stmt\ClassMethod|Node\Stmt\Function_|null
     */
    private $node;
    ...
    public function getParameters(): array
    {
        ...
        /** @psalm-var list<Node\Param> $nodeParams */
     ...
     *
     * @return Node\FunctionLike|Node\Stmt\ClassMethod|Node\Stmt\Function_
     */
