...
use voku\SimplePhpParser\BetterReflectionForOldPhp\Reflection\Exception\NotAClassReflection;
use voku\SimplePhpParser\BetterReflectionForOldPhp\Reflection\Exception\NotAnInterfaceReflection;
use voku\SimplePhpParser\BetterReflectionForOldPhp\Reflection\Exception\NotAnObject;
use voku\SimplePhpParser\BetterReflectionForOldPhp\Reflection\Exception\ObjectNotInstanceOfClass;
use voku\SimplePhpParser\BetterReflectionForOldPhp\Reflection\Exception\PropertyDoesNotExist;
use voku\SimplePhpParser\BetterReflectionForOldPhp\Reflection\Exception\Uncloneable;
use voku\SimplePhpParser\BetterReflectionForOldPhp\Reflection\StringCast\ReflectionClassStringCast;
...
class ReflectionClass implements Reflection
{
     ...
     *
     * @pslam-return list<ReflectionMethod>
     */
    ...
    public function getReflectionConstants(): array
    {
        ...
        $allReflectionConstants = \array_merge(
            ...
            ...\array_map(
                static function (self $ancestor): array {
                    return \array_filter(
            ...
            ...\array_map(
                static function (self $interface): array {
        ...
        if ($this->cachedProperties === null) {
            ...
            $this->cachedProperties = \array_merge(
                \array_merge(
                    [],
                    ...\array_map(
                        static function (self $ancestor) use ($filter): array {
                            return \array_filter(
                    ...
                    ...\array_map(
                        function (self $trait) use ($filter) {
     ...
     * @return string[]
     *
     * @psalm-return list<class-string> A numerical array with parent class names as the values.
     */
    ...
    {
        return \array_map(
            function (Node\Name $importedTrait): self {
    ...
    {
        return \array_map(
            static function (self $trait): string {
     ...
     * Gets the interfaces.
     *
     * @see https://php.net/manual/en/reflectionclass.getinterfaces.php
     *
     ...
     *
     * @see https://php.net/manual/en/reflectionclass.getinterfacenames.php
     *
     * @return string[]
     *
     * @psalm-return list<string> A numerical array with interface names as the values.
     */
     ...
     *
     * @see https://php.net/manual/en/reflectionclass.isinstance.php
     *
     * @param \object $object
     *
     * @return bool
     ...
     *
     * @see https://php.net/manual/en/reflectionclass.implementsinterface.php
     *
     ...
     *
     * @see https://php.net/manual/en/reflectionclass.isinstantiable.php
     */
     ...
     *
     * @see https://php.net/manual/en/reflectionclass.iscloneable.php
     */
     ...
     *
     * @see https://php.net/manual/en/reflectionclass.isiterateable.php
     */
