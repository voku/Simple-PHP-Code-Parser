...
use voku\SimplePhpParser\BetterReflectionForOldPhp\Reflection\StringCast\ReflectionPropertyStringCast;
...
use voku\SimplePhpParser\BetterReflectionForOldPhp\TypesFinder\FindPropertyType;
...
class ReflectionProperty
{
     ...
     * @param Namespace_|null $declaringNamespace
    ...
    public function getValue($object = null)
    {
        ...
        return Closure::bind(
            static function ($instance, string $propertyName) {
    ...
    public function setValue($object, $value = null): void
    {
        ...
        Closure::bind(static function ($instance, string $propertyName, $value): void {
