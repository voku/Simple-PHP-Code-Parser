        ...
        static::assertSame(
            [
                'Simple-PHP-Code-Parser/tests/Dummy3.php' => [
                    ...
                    3 => '[38]: missing parameter type for voku\tests\Dummy3->lall() | parameter:foo',
                    4 => '[38]: missing return type for voku\tests\Dummy3->lall()',
                    5 => '[68]: wrong return type "string" in phpdoc from voku\tests\Dummy3->lall3()',
                    6 => '[58]: wrong return type "null" in phpdoc from voku\tests\Dummy3->lall2_1()',
                    7 => '[48]: missing return type "null" in phpdoc from voku\tests\Dummy3->lall2()',
                    8 => '[78]: wrong parameter type "string" in phpdoc from voku\tests\Dummy3->lall3_1()  | parameter:foo',
                ],
            ],
            $phpCodeErrors
        );
